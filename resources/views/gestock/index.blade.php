...
<div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="">
        ...
        <div class="space-y-2">
            ...
            <p><i class="fa-solid fa-circle-exclamation" style="color: #C53030;"></i> <strong> Attention</strong>, après avoir pris en compte tous les éléments pertinents (date de livraison fournisseur, délai d'installation, et date d'installation prévue), il semble que la <a href="{{ route('commande.show', $id) }}" class="underline hover:text-red-300 font-semibold">Commande n°{{ $id }}</a> (Client : {{ $alerte['commande']->client?->code_client ?? 'Non défini' }}) présente un risque potentiel de retard. Nous vous prions de bien vouloir contacter le founisseur afin de clarifier la situation et, si nécessaire, informer le client.</p>
            </div>
            @endforeach
        </div>
    </div>
