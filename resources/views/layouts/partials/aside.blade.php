<nav>
    <ul class="flex flex-col p-4 gap-4">
        ...
        <a href="" class="{{ Request::is('gestatelier') ? 'bg-green-700 px-2 py-1 text-white font-semibold' : 'hover:bg-green-700 hover:px-2 hover:py-1 hover:text-white transition-all duration-300 hover:font-semibold' }} rounded-lg">
            <i class="fa-solid fa-wrench"></i> <span class="ml-2">GestAtelier</span>
        </a>
        <a href="" class="{{ Request::is('gestsav') ? 'bg-green-700 px-2 py-1 text-white font-semibold' : 'hover:bg-green-700 hover:px-2 hover:py-1 hover:text-white transition-all duration-300 hover:font-semibold' }} rounded-lg">
