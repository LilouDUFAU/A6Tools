<nav>
    <ul class="flex flex-col p-4 gap-4">
        <a href="" class="hidden md:flex justify-center"><img src="{{ asset('/images/logo_a6tools.png') }}" alt="Logo" class="w-64 h-auto mb-2 md:mb-4"></a>
        <a href="" class="flex md:hidden hover:bg-green-700 rounded-lg hover:px-2 hover:py-1 hover:text-white transition-all duration-300 hover:font-semibold"><i class="fa-solid fa-house"></i> <span class="ml-2">Accueil</span></a>
