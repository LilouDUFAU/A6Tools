<nav>
    <ul class="flex flex-col p-4 gap-4">
        ...
        <a href="{{ route('gestrenouv.index') }}" class="hover:bg-green-700 rounded-lg hover:px-2 hover:py-1 hover:text-white transition-all duration-300 hover:font-semibold"><i class="fa-solid fa-desktop"></i> <span class="ml-2">GestRenouv</span></a>
