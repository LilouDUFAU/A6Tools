                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Vous allez louer plusieurs PC avec la référence <strong>{{ $pcrenouv->reference }}</strong>.
        ...
        <div class="border-l-4 border-green-600 pl-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="numero_serie" id="numero_serie"
                    value="{{ old('reference', isset($pcrenouv->isGroup) && $pcrenouv->isGroup ? 'location-multiple' : 'location-' . $pcrenouv->numero_serie) }}"
                    class="mt-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-2 py-1 cursor-not-allowed"
                    required maxlength="255" readonly>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Entrez le nombre d'unités à louer (maximum: {{ isset($pcrenouv->isGroup) && $pcrenouv->isGroup ? $pcrenouv->totalQuantity : ($pcrenouv->stocks->first()?->pivot->quantite ?? 0) }})
                </p>
            </div>
