...
<h1 class="text-3xl font-extrabold text-gray-800 mb-8">Ajouter un PC Renouv</h1>
    <form action="{{ route('gestrenouv.store') }}" method="POST" class="space-y-6">
        ...
        <div class="border-l-4 border-green-600 pl-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="numero_serie" name="numero_serie" class="mt-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-2 py-1" value="{{ old('numero_serie') }}" required>
                @error('numero_serie')
            ...
            <div class="mb-4">
                ...
                <input type="text" id="reference" name="reference" class="mt-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-2 py-1" value="{{ old('reference') }}" required>
                @error('reference')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="quantite" name="quantite" min="1" class="mt-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-2 py-1" value="{{ old('quantite', 1) }}" required>
                @error('quantite')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="border-l-4 border-green-600 pl-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="stock_quantite" name="stock_quantite" min="1" class="mt-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-2 py-1" value="{{ old('stock_quantite', 1) }}" required>
        ...
        <div class="border-l-4 border-green-600 pl-4">
            ...
            <div class="mb-4">
                ...
                <textarea id="caracteristiques" name="caracteristiques" rows="4" class="mt-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-2 py-1" required>{{ old('caracteristiques') }}</textarea>
